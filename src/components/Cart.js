...
import Fade from 'react-reveal/Fade'  // "react-reveal" is a react package for animation
    ...
    <>
       {
          ...
          <div className='show-price'>Yoy have {cartItems.length} items in the basket</div>
       }
                        ...
                        <div key={element.id} className='product-item'>
                           ...
                           <div className='product-price'>
                              ...
                              <div className='remove-item'>
                                 <button onClick={()=>removeFromBasket(element)}>Remove from basket</button>
                              </div>
                           </div>
                        </div>
                    </Fade>
